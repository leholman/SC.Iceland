...
####====4.0 Code basement ====####
# bits and bobs - old experiments and trials etc.
...
plot(EUK.GC1.nMDS.b$points[,1],EUK.GC1.nMDS.b$points[,2],xlab="nMDS1",ylab="nMDS2",pch=16,col=map_values_to_colors(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred"))
plot_with_gradient_legend(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred")
plot(EUK.GC1.nMDS.b$points[,1],EUK.GC1.nMDS.b$points[,3],xlab="nMDS1",ylab="nMDS3",pch=16,col=map_values_to_colors(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred"))
plot(EUK.GC1.nMDS.b$points[,2],EUK.GC1.nMDS.b$points[,3],xlab="nMDS2",ylab="nMDS3",pch=16,col=map_values_to_colors(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred"))
dev.off()

pdf("figures/EUK.GC1.bray.nMDS.linear.pdf",width = 8,height = 8)
par(mfrow=c(3,1),mar=c(5.1, 4.1, 1.1, 1.1),xpd=TRUE)
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)],EUK.GC1.nMDS.b$points[,1],pch=16,ylab="nMDS 1",xlab="Yr Cal BP")
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)],EUK.GC1.nMDS.b$points[,2],pch=16,ylab="nMDS 2",xlab="Yr Cal BP")
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.GC1.nMDS.b$points)),ages$ID2)],EUK.GC1.nMDS.b$points[,3],pch=16,ylab="nMDS 3",xlab="Yr Cal BP")
dev.off()
...
GC1.MDS.b.gam.dat  <- data.frame("year"=ages$mean[match(rownames(EUK.GC1.MDS.b$points),ages$ID2)],
...
plot(ages$mean[match(rownames(EUK.GC1.MDS.b$points),ages$ID2)],EUK.GC1.MDS.b$points[,1],pch=16,ylab="MDS 1",xlab="Yr Cal BP")
...
plot(ages$mean[match(rownames(EUK.GC1.MDS.b$points),ages$ID2)],EUK.GC1.MDS.b$points[,2],pch=16,ylab="MDS 2",xlab="Yr Cal BP")
...
plot(ages$mean[match(rownames(EUK.GC1.MDS.b$points),ages$ID2)],EUK.GC1.MDS.b$points[,3],pch=16,ylab="MDS 3",xlab="Yr Cal BP")
...
plot(ages$mean[match(rownames(EUK.GC1.MDS.b$points),ages$ID2)],EUK.GC1.MDS.b$points[,4],pch=16,ylab="MDS 4",xlab="Yr Cal BP")
...
#GAMS
GC1.MDS.j.gam.dat  <- data.frame("year"=ages$mean[match(rownames(EUK.GC1.MDS.j$points),ages$ID2)],
...
par(mfrow=c(4,1),mar=c(2, 4.1, 1.1, 1.1))
plot(ages$mean[match(rownames(EUK.GC1.MDS.j$points),ages$ID2)],EUK.GC1.MDS.j$points[,1],pch=16,ylab="MDS 1",xlab="Yr Cal BP")
polygon(c(prediction1$year, rev(prediction1$year)), c(prediction1$uppCI, rev(prediction1$lwrCI)), col=add.alpha('dodgerblue',0.3), border=NA)
points(prediction1$year,prediction1$fit,lwd=2,col="dodgerblue",type='l')
plot(ages$mean[match(rownames(EUK.GC1.MDS.j$points),ages$ID2)],EUK.GC1.MDS.j$points[,2],pch=16,ylab="MDS 2",xlab="Yr Cal BP")
polygon(c(prediction2$year, rev(prediction2$year)), c(prediction2$uppCI, rev(prediction2$lwrCI)), col=add.alpha('pink3',0.3), border=NA)
points(prediction2$year,prediction2$fit,lwd=2,col="pink3",type='l')
plot(ages$mean[match(rownames(EUK.GC1.MDS.j$points),ages$ID2)],EUK.GC1.MDS.j$points[,3],pch=16,ylab="MDS 3",xlab="Yr Cal BP")
polygon(c(prediction3$year, rev(prediction3$year)), c(prediction3$uppCI, rev(prediction3$lwrCI)), col=add.alpha('darkgreen',0.3), border=NA)
points(prediction3$year,prediction3$fit,lwd=2,col="darkgreen",type='l')
plot(ages$mean[match(rownames(EUK.GC1.MDS.j$points),ages$ID2)],EUK.GC1.MDS.j$points[,4],pch=16,ylab="MDS 4",xlab="Yr Cal BP")
polygon(c(prediction4$year, rev(prediction4$year)), c(prediction4$uppCI, rev(prediction4$lwrCI)), col=add.alpha('gold',0.3), border=NA)
points(prediction4$year,prediction4$fit,lwd=2,col="gold",type='l')
dev.off()
...
par(mfrow=c(1,3),mar=c(5.1, 4.1, 1.1, 1.1),xpd=TRUE)
plot(EUK.P19.nMDS.b$points[,1],EUK.P19.nMDS.b$points[,2],xlab="nMDS1",ylab="nMDS2",pch=16,col=map_values_to_colors(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred"))
plot_with_gradient_legend(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred")
plot(EUK.P19.nMDS.b$points[,1],EUK.P19.nMDS.b$points[,3],xlab="nMDS1",ylab="nMDS3",pch=16,col=map_values_to_colors(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred"))
plot(EUK.P19.nMDS.b$points[,2],EUK.P19.nMDS.b$points[,3],xlab="nMDS2",ylab="nMDS3",pch=16,col=map_values_to_colors(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)], "dodgerblue", "darkred"))
dev.off()

pdf("figures/EUK.P19.bray.nMDS.linear.pdf",width = 8,height = 8)
par(mfrow=c(3,1),mar=c(5.1, 4.1, 1.1, 1.1),xpd=TRUE)
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],EUK.P19.nMDS.b$points[,1],pch=16,ylab="nMDS 1",xlab="Yr Cal BP")
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],EUK.P19.nMDS.b$points[,2],pch=16,ylab="nMDS 2",xlab="Yr Cal BP")
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],EUK.P19.nMDS.b$points[,3],pch=16,ylab="nMDS 3",xlab="Yr Cal BP")
dev.off()

pdf("figures/EUK.P19.bray.nMDS.linear.short.pdf",width = 8,height = 8)
par(mfrow=c(3,1),mar=c(5.1, 4.1, 1.1, 1.1),xpd=TRUE)
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],EUK.P19.nMDS.b$points[,1],pch=16,xlim=c(200,1850),ylab="nMDS 1",xlab="Yr Cal BP")
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],EUK.P19.nMDS.b$points[,2],pch=16,xlim=c(200,1850),ylab="nMDS 2",xlab="Yr Cal BP")
plot(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],EUK.P19.nMDS.b$points[,3],pch=16,xlim=c(200,1850),ylab="nMDS 3",xlab="Yr Cal BP")
dev.off()
...
test <- tapply(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],
       INDEX=gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),FUN=mean)

example_dat  <- data.frame("example_x"=ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],
                           "example_y"=EUK.P19.nMDS.b$points[,3])

example_dat_mean  <- data.frame("example_x"=tapply(ages$mean[match(gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),ages$ID2)],INDEX=gsub("(.*)_[0-9]$","\\1",rownames(EUK.P19.nMDS.b$points)),FUN=mean),
...
P19.MDS.b.gam.dat  <- data.frame("year"=ages$mean[match(rownames(EUK.P19.MDS.b$points),ages$ID2)],
...
par(mfrow=c(4,1),mar=c(2, 4.1, 1.1, 1.1))
plot(ages$mean[match(rownames(EUK.P19.MDS.b$points),ages$ID2)],EUK.P19.MDS.b$points[,1],pch=16,ylab="MDS 1",xlab="Yr Cal BP")
polygon(c(prediction1$year, rev(prediction1$year)), c(prediction1$uppCI, rev(prediction1$lwrCI)), col=add.alpha('dodgerblue',0.3), border=NA)
points(prediction1$year,prediction1$fit,lwd=2,col="dodgerblue",type='l')
plot(ages$mean[match(rownames(EUK.P19.MDS.b$points),ages$ID2)],EUK.P19.MDS.b$points[,2],pch=16,ylab="MDS 2",xlab="Yr Cal BP")
polygon(c(prediction2$year, rev(prediction2$year)), c(prediction2$uppCI, rev(prediction2$lwrCI)), col=add.alpha('pink3',0.3), border=NA)
points(prediction2$year,prediction2$fit,lwd=2,col="pink3",type='l')
plot(ages$mean[match(rownames(EUK.P19.MDS.b$points),ages$ID2)],EUK.P19.MDS.b$points[,3],pch=16,ylab="MDS 3",xlab="Yr Cal BP")
polygon(c(prediction3$year, rev(prediction3$year)), c(prediction3$uppCI, rev(prediction3$lwrCI)), col=add.alpha('darkgreen',0.3), border=NA)
points(prediction3$year,prediction3$fit,lwd=2,col="darkgreen",type='l')
plot(ages$mean[match(rownames(EUK.P19.MDS.b$points),ages$ID2)],EUK.P19.MDS.b$points[,4],pch=16,ylab="MDS 4",xlab="Yr Cal BP")
polygon(c(prediction4$year, rev(prediction4$year)), c(prediction4$uppCI, rev(prediction4$lwrCI)), col=add.alpha('gold',0.3), border=NA)
points(prediction4$year,prediction4$fit,lwd=2,col="gold",type='l')
dev.off()
...
P19.MDS.j.gam.dat  <- data.frame("year"=ages$mean[match(rownames(EUK.P19.MDS.j$points),ages$ID2)],
...
par(mfrow=c(4,1),mar=c(2, 4.1, 1.1, 1.1))
plot(ages$mean[match(rownames(EUK.P19.MDS.j$points),ages$ID2)],EUK.P19.MDS.j$points[,1],pch=16,ylab="MDS 1",xlab="Yr Cal BP")
polygon(c(prediction1$year, rev(prediction1$year)), c(prediction1$uppCI, rev(prediction1$lwrCI)), col=add.alpha('dodgerblue',0.3), border=NA)
points(prediction1$year,prediction1$fit,lwd=2,col="dodgerblue",type='l')
plot(ages$mean[match(rownames(EUK.P19.MDS.j$points),ages$ID2)],EUK.P19.MDS.j$points[,2],pch=16,ylab="MDS 2",xlab="Yr Cal BP")
polygon(c(prediction2$year, rev(prediction2$year)), c(prediction2$uppCI, rev(prediction2$lwrCI)), col=add.alpha('pink3',0.3), border=NA)
points(prediction2$year,prediction2$fit,lwd=2,col="pink3",type='l')
plot(ages$mean[match(rownames(EUK.P19.MDS.j$points),ages$ID2)],EUK.P19.MDS.j$points[,3],pch=16,ylab="MDS 3",xlab="Yr Cal BP")
polygon(c(prediction3$year, rev(prediction3$year)), c(prediction3$uppCI, rev(prediction3$lwrCI)), col=add.alpha('darkgreen',0.3), border=NA)
points(prediction3$year,prediction3$fit,lwd=2,col="darkgreen",type='l')
plot(ages$mean[match(rownames(EUK.P19.MDS.j$points),ages$ID2)],EUK.P19.MDS.j$points[,4],pch=16,ylab="MDS 4",xlab="Yr Cal BP")
polygon(c(prediction4$year, rev(prediction4$year)), c(prediction4$uppCI, rev(prediction4$lwrCI)), col=add.alpha('gold',0.3), border=NA)
points(prediction4$year,prediction4$fit,lwd=2,col="gold",type='l')
dev.off()
